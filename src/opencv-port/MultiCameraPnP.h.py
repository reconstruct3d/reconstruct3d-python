...
class MultiCameraPnP : public MultiCameraDistance	std.vector<CloudPoint> pointcloud_beforeBA
...
public:
	...
	std.vector<cv.Point3d> getPointCloudBeforeBA() { return CloudPointsToPoints(pointcloud_beforeBA);
	 std.vector<cv.Vec3b>& getPointCloudRGBBeforeBA() { return pointCloudRGB_beforeBA;
...
private:
	...
	int FindHomographyInliers2Views(int vi, vj)
	int m_first_view
